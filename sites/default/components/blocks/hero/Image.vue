    ...
    <div class="-mb-5 lg:container">
        ...
        >
            <div class="relative lg:rounded">
                <SplideTrack class="lg:rounded lg:shadow-lg">
                    <SplideSlide
                ...
                <div class="splide__arrows pointer-events-none  -mt-5 flex items-center justify-center lg:relative">
                    <div class="pointer-events-auto z-10 inline-flex items-center justify-center rounded-full bg-white px-2 shadow-lg ring-1 ring-black/10 lg:mt-0">
                        ...
                        <div
                            class="splide__pagination [&_button:hover]:after:bg-brand-500 [&_button.is-active:hover]:after:bg-white [&_button.is-active]:after:scale-150 [&_button.is-active]:after:bg-white [&_button.is-active]:after:shadow [&_button.is-active]:after:ring-1 [&_button.is-active]:after:ring-black/5 [&_button]:flex [&_button]:size-6 [&_button]:items-center [&_button]:justify-center [&_button]:after:block [&_button]:after:size-2 [&_button]:after:rounded-full [&_button]:after:bg-gray-200 [&_button]:after:transition-all"
                        >
                        </div>
