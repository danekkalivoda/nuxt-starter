...
<template>
    <Dialog as="div" class="lg:hidden" :open="isOpen" @close="emit('on-menu-toggle', false)">
                ...
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <template v-for="item in menu" :key="item.title">
                            <Disclosure v-if="item.children" v-slot="{ open }" as="div" class="-mx-3">
                                <DisclosureButton
                    ...
                    <div v-if="locales.length !== 1" class="py-6">
